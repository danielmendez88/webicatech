...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css_/sb-admin-2.min.css') }}">
</head>
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
    ...
    <script src="{{asset("assets/vendor/jquery-sb2/jquery.js")}}"></script>
    <script src="{{ asset('assets/js_/sb-admin-2.js') }}"></script>
