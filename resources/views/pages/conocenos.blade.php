		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					<img src="{{ asset('Imagenes pagina/mision.jpg') }}" class="card-img-bottom" alt="...">
				</div>
			</div>
			<div class="col-md-6">
				<div class="card">
					...
					<img src="{{ asset('Imagenes pagina/vision.jpg') }}" class="card-img-bottom" alt="...">
				</div>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="row">
						<div class="col-md-4">
							<img src="{{ asset('Imagenes pagina/objetivos_icatech.png') }}" alt="...">
						</div>
